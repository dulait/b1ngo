...
internal sealed class DocumentTransformer : IOpenApiDocumentTransformer
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        [
            ...
            new OpenApiServer
            {
                Url = "https://api.b1ngo.dev",
                Description = "Production server",
            },
        ];

        document.AddComponent("playerToken", new OpenApiSecurityScheme
        {
    ...
    {
        document.AddComponent("RoomStatus", new OpenApiSchema
        {
        ...
        document.AddComponent("SquareMarkedBy", new OpenApiSchema
        {
            Type = JsonSchemaType.String,
            Enum =
            [
