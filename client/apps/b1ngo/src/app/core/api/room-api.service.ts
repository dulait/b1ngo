...
export class RoomApiService {
  ...
  markSquare(roomId: string, playerId: string, row: number, col: number): Promise<void> {
    return firstValueFrom(
      this.http.post<void>(
  ...
  unmarkSquare(roomId: string, playerId: string, row: number, col: number): Promise<void> {
    return firstValueFrom(
      this.http.post<void>(
